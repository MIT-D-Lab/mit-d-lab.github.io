...
[The Art + Science of PCB Design ↗](https://pcb.mit.edu) is an IAP course about designing circuit boards. All the course content is freely avaliable online. Specificaly, see the [resources](https://pcb.mit.edu/resources/) page!
...
[KiCAD ↗](https://www.kicad.org) is a free multi-platform PCB design software. [Altium Designer ↗](https://www.altium.com/education/students) is a more industry-oriented tool for PCB design but only runs on Windows. **KiCAD also has an in-built LT-Spice Circuit simulator.**
